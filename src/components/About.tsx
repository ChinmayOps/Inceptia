      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 max-w-2xl mx-auto">
            A 48-hour coding competition where creativity meets technology to solve real-world challenges.
          </p>
        </div>
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-8">
            <CardContent className="pt-6">
              ...
              <p className="text-white/70 mb-6">
                Our hackathon offers a unique opportunity to collaborate with like-minded individuals, learn from industry experts, and showcase your skills. Throughout the event, you'll have access to mentors, workshops, and networking opportunities to help you succeed.
              </p>
              <p className="text-white/70">
                Whether you're a seasoned developer, a creative designer, or just starting your tech journey, this hackathon is designed to challenge and inspire you.
              </p>
            </CardContent>
          </Card>
        </div>
