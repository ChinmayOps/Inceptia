  ...
  return (
    <div className="min-h-screen bg-background px-4 pt-20 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20 z-0">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-primary/40 blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/3 w-96 h-96 rounded-full bg-secondary/30 blur-3xl animate-pulse delay-1000"></div>

        {/* Captain America's Shield Design */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="w-72 h-72 rounded-full border-4 border-primary/30 flex items-center justify-center">
            <div className="w-56 h-56 rounded-full border-4 border-accent/30 flex items-center justify-center">
              <div className="w-36 h-36 rounded-full border-4 border-secondary/30" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative w-full max-w-md md:max-w-full mx-auto">
          ...
          <div className="absolute -bottom-4 -right-4 w-48 sm:w-72 h-48 sm:h-72 bg-primary/20 rounded-full blur-3xl" />
        </div>
      </div>
    </div>
  );
