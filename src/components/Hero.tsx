        ...
        <div className="space-y-6 md:space-y-8 text-center md:text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 pt-6 sm:pt-8">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-white">24<span className="text-primary">hrs</span></div>
              <div className="text-white/60">Hackathon</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-white">₹50<span className="text-primary">k</span></div>
              <div className="text-white/60">Prize Pool</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-white">400<span className="text-primary">+</span></div>
              <div className="text-white/60">Participants</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-full max-w-md mx-auto md:max-w-full">
          <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-2 border-primary/50">
            <img 
              src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81" 
              alt="Inceptia Hackathon"
              className="w-full h-auto brightness-90 object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-background via-background/50 to-transparent opacity-80"></div>
          ...
          <div className="absolute -bottom-4 -right-4 w-48 sm:w-72 h-48 sm:h-72 bg-primary/20 rounded-full blur-3xl"></div>
        </div>
      </div>
    </div>
  );
